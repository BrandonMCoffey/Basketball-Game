...
namespace CoffeyUtils
{
	public class AnimatedButtonHoverSelect : MonoBehaviour, ISelectHandler, IDeselectHandler, ISubmitHandler, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
	{
		...
		[SerializeField, ShowIf(nameof(_animateScale))] private Transform _transform;
		[SerializeField, ShowIf(nameof(_animateScale))] private float _animationTime = 0.2f;
		[SerializeField, ShowIf(nameof(_animateScale))] private float _widthScale = 1.06f;
		[SerializeField, ShowIf(nameof(_animateScale))] private float _heightScale = 1.12f;
		[SerializeField, ShowIf(nameof(_animateScale))] private AnimationCurve _deltaCurve
